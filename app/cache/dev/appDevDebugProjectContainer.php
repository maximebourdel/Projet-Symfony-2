...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SdzBlogBundle', '/var/www/html/Symfony/app/Resources/SdzBlogBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SdzBlogBundle', '/var/www/html/Symfony/src/Sdz/BlogBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['assetic.filter.less'] = $instance = new \Assetic\Filter\LessFilter('/usr/bin/nodejs', array(0 => '/usr/local/lib/node:/usr/local/lib/node_modules:/root/node_modules'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager53b06940d91f9_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager53b06940d91f9_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/html/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_53b06940d91f9.php';
        ...
        $d->setNamespace('sf2orm_default_3095ad44482b0b14fd2641e9bcf228d07a8246addca0a5d986959b84c20b4e99');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/var/www/html/Symfony/src/Sdz/BlogBundle/Entity', 1 => '/var/www/html/Symfony/src/Sdz/UserBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/var/www/html/Symfony/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine' => 'FOS\\UserBundle\\Entity'));
        $f->setGlobalBasename('mapping');

        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $g->addDriver($e, 'Sdz\\BlogBundle\\Entity');
        $g->addDriver($e, 'Sdz\\UserBundle\\Entity');
        $g->addDriver($f, 'FOS\\UserBundle\\Entity');
        $g->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('/var/www/html/Symfony/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine/model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('SdzBlogBundle' => 'Sdz\\BlogBundle\\Entity', 'SdzUserBundle' => 'Sdz\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('/var/www/html/Symfony/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager53b06940d91f9_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h->createUser(new \Symfony\Component\Security\Core\User\User('auteur', 'auteurpass', array(0 => 'ROLE_AUTEUR')));

        $i = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, '/blog'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
        $j->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $k = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($i, array('login_path' => 'login', 'default_target_path' => '/blog', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $k->setProviderKey('main');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $h, 1 => $this->get('security.user.provider.concrete.main')), 'main', $a, $c), 2 => $j, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $i, 'main', $k, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $i, array('login_path' => 'login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '53b06940a5c84', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $i, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $i, 'login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_AUTEUR' => array(), 'ROLE_ADMIN' => array(0 => 'ROLE_AUTEUR', 1 => 'ROLE_MODERATEUR'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'MopaBootstrapBundle:Form:fields.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'SdzBlogBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/html/Symfony/src/Sdz/BlogBundle/Resources/views', 'SdzBlog');
        $instance->addPath('/var/www/html/Symfony/vendor/mopa/bootstrap-bundle/Mopa/Bundle/BootstrapBundle/Resources/views', 'MopaBootstrap');
        $instance->addPath('/var/www/html/Symfony/src/Sdz/UserBundle/Resources/views', 'SdzUser');
        $instance->addPath('/var/www/html/Symfony/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/views', 'FOSUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('039c5e4aa1d931065f999917d33042d7c7128176');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/var/www/html/Symfony/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/var/www/html/Symfony/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation.xml'));
        ...
        $instance->addXmlMapping('/var/www/html/Symfony/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/DependencyInjection/Compiler/../../Resources/config/validation/orm.xml');
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Sdz\\UserBundle\\Entity\\User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'bourdel.maxime.pro@gmail.com',
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '039c5e4aa1d931065f999917d33042d7c7128176',
            ...
            'kernel.secret' => '039c5e4aa1d931065f999917d33042d7c7128176',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'bourdel.maxime.pro@gmail.com',
            ...
            'assetic.filter.less.node_paths' => array(
                0 => '/usr/local/lib/node:/usr/local/lib/node_modules:/root/node_modules',
            ),
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/html/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_53b06940d91f9.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager53b06940d91f9_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
