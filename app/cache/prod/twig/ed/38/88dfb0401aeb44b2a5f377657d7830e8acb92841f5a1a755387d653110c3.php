...
class __TwigTemplate_ed3888dfb0401aeb44b2a5f377657d7830e8acb92841f5a1a755387d653110c3 extends Twig_Template
{
    ...
    ";
        ...
        <ul>
            ";
            // line 6
            $template = $this->env->resolveTemplate((isset($context["item"]) ? $context["item"] : null));
            $template->display(array_merge($context, array("name" => "first", "text" => "«", "page" => ((array_key_exists("first", $context)) ? ((isset($context["first"]) ? $context["first"] : null)) : (null)), "clickable" => (array_key_exists("first", $context) && ((isset($context["current"]) ? $context["current"] : null) != (isset($context["first"]) ? $context["first"] : null))))));
            // line 12
            echo "
            ";
            // line 13
            $template = $this->env->resolveTemplate((isset($context["item"]) ? $context["item"] : null));
            $template->display(array_merge($context, array("name" => "prev", "text" => ("‹ " . $this->env->getExtension('translator')->trans("Previous", array(), "pagination")), "page" => ((array_key_exists("previous", $context)) ? ((isset($context["previous"]) ? $context["previous"] : null)) : (null)), "clickable" => array_key_exists("previous", $context))));
            // line 19
            echo "
            ";
            // line 20
            ...
            // line 25
            $template = $this->env->resolveTemplate((isset($context["item"]) ? $context["item"] : null));
            $template->display(array_merge($context, array("name" => "next", "text" => ($this->env->getExtension('translator')->trans("Next", array(), "pagination") . " ›"), "page" => ((array_key_exists("next", $context)) ? ((isset($context["next"]) ? $context["next"] : null)) : (null)), "clickable" => array_key_exists("next", $context))));
            // line 32
            echo "
            ";
            // line 34
            $template = $this->env->resolveTemplate((isset($context["item"]) ? $context["item"] : null));
            $template->display(array_merge($context, array("name" => "last", "text" => "»", "page" => ((array_key_exists("last", $context)) ? ((isset($context["last"]) ? $context["last"] : null)) : (null)), "clickable" => (array_key_exists("last", $context) && ((isset($context["current"]) ? $context["current"] : null) != (isset($context["last"]) ? $context["last"] : null))))));
            // line 41
            echo "        </ul>
    </div>
";
